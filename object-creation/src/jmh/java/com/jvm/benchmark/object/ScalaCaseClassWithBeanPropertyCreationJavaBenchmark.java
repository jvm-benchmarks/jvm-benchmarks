...
@Fork(5)
public class ScalaCaseClassWithBeanPropertyCreationJavaBenchmark {
    ...
    public CaseClassWithBeanProperty creation_NewInstance() {
        return new CaseClassWithBeanProperty(stringValue, intValue, longValue, doubleValue, ZonedDateTime.now(NanoClock.getInstance()), NanoClock.getInstance().instant());
    }
}
